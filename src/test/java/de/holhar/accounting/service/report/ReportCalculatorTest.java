...
class ReportCalculatorTest {
    ...
    void addToCostCentres() {
        ...
        Entry entry1 = TestUtils.getCheckingAccountEntryAmountAndClientOnly("-69.99", "XX sportsEquipment YY", EntryType.LEISURE_ACTIVITIES_AND_PURCHASES);
        Entry entry2 = TestUtils.getCheckingAccountEntryAmountAndClientOnly("-112.83", "XX sportsEquipment ZZ", EntryType.LEISURE_ACTIVITIES_AND_PURCHASES);
