...
public class CliAdapter {
    ...
    public void startApplication() {
        ...
        try {
            ...
            Map<Integer, List<MonthlyReport>> monthlyReportsPerYear = accountingService.createReport(csvPath);
    ...
    private void createCSVReport(Path csvPath, Map<Integer, List<MonthlyReport>> monthlyReportsPerYear) throws IOException {
    ...
    private void processReports(CSVPrinter csvPrinter, List<MonthlyReport> reportSet, AnnualReport annualReport) throws IOException {
