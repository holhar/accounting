...
class AccountStatementDeserializerTest {
    ...
    void readStatement() throws IOException {
        // Given
        AccountStatementDeserializer deserializer = new AccountStatementDeserializer();
        ...
        AccountStatement.Entry firstEntry = accountStatement.getEntries().get(0);
        ...
        assertEquals("9876543210987645 08.39 PETER LUSTIG XXX INTERNET BANKING DATUM 31.01.2020, 08.39 UHR", firstEntry.getIntendedUse());
        ...
        AccountStatement.Entry lastEntry = accountStatement.getEntries().get(30);
        ...
        assertEquals("/RFB/P0000000000/0001, 02.01.2222,42Sub Rate PremiumSubscription 68482646 XXYYX+Blubber Enterprises", lastEntry.getIntendedUse());
