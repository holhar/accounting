...
//
//    // When
//    MonthlyReport monthlyReport = manager.createMonthlyReport(checkingAccountStatement.getFrom(),
//        statementSet);
//
//    // Then
...
//        () -> manager.createMonthlyReport(from, statementSet));
//
//    // Then
...
//    creditCardEntries.add(
//        TestUtils.getCheckingAccountEntryAmountAndClientOnly("200.00", "CHECKING_ACCOUNT_ID",
//            EntryType.INCOME)); // <= is own transfer
//    creditCardEntries.add(TestUtils.getCheckingAccountEntryAmountAndClientOnly("-10.00", "cinema",
//        EntryType.LEISURE_ACTIVITIES_AND_PURCHASES));
//    creditCardEntries.add(
//        TestUtils.getCheckingAccountEntryAmountAndClientOnly("-25.96", "restaurant",
//            EntryType.LEISURE_ACTIVITIES_AND_PURCHASES));
//    creditCardEntries.add(
//        TestUtils.getCheckingAccountEntryAmountAndClientOnly("-9.99", "music provider",
//            EntryType.LEISURE_ACTIVITIES_AND_PURCHASES));
...
//    checkingAccountEntries.add(
//        TestUtils.getCheckingAccountEntryAmountAndClientOnly("2400.15", "employer",
//            EntryType.INCOME));
//    checkingAccountEntries.add(
//        TestUtils.getCheckingAccountEntryAmountAndClientOnly("-500.45", "landlord",
//            EntryType.ACCOMMODATION_AND_COMMUNICATION));
//    checkingAccountEntries.add(
//        TestUtils.getCheckingAccountEntryAmountAndClientOnly("-207.96", "groceries",
//            EntryType.FOOD_AND_DRUGSTORE));
//    checkingAccountEntries.add(
//        TestUtils.getCheckingAccountEntryAmountAndClientOnly("-200.00", "a friend",
//            EntryType.MISCELLANEOUS));
//    checkingAccountEntries.add(
//        TestUtils.getCheckingAccountEntryAmountAndClientOnly("-154.45", "depot transfer 1",
//            EntryType.DEPOT_TRANSFER));
//    checkingAccountEntries.add(
//        TestUtils.getCheckingAccountEntryAmountAndClientOnly("-146.56", "depot transfer 2",
//            EntryType.DEPOT_TRANSFER));
//    return new AccountStatement(
//        "CHECKING_ACCOUNT_ID",
